...
const Navbar = () => {
  ...
  return (
    <div
      className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 
    ...
    >
      ...
      <div className="md:hidden lg:flex xl:w-1/3 xl:justify-center">
        <Link
          ...
          justify-center"
        >
          <span className="text-white mr-1 ">TheLordMTA</span>
          <span
            className="w-12 h-8 rounded bg-white text-black flex items-center 
          justify-center"
          >
            .dev
          </span>
